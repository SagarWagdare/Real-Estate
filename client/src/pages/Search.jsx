...
const Search = () => {
  return (
    <div className="flex flex-col md:flex-row">
      <div className="p-7 border-b-2 sm:border-r-2 md:min-h-screen">
        <form className="flex flex-col gap-8">
          <div className="flex items-center gap-2">
            ...
            <input type="text" id="searchTerm" placeholder="Search.." className="p-3 w-full rounded-lg"/>
          </div>
      ...
      <button className="bg-slate-700 text-white p-3 hover:opacity-95 rounded-lg">Search</button>
        </form>
      </div>
      <div className="">
